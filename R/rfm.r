...
print salesRFM$rankR
print salesRFM$rankF
print salesRFM$rankM
print "recency vs frequency"
print table(salesRFM(,5:6))
print "frequency vs monetization"
print table(salesRFM(,6:7))
print "recency vs monetization"
print table(salesRFM(,5:7))
